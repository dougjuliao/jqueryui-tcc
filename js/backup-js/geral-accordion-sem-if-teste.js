$(document).ready(function(){
    ...
    function botoesmenu(){
        ...
        $(".menu-accordion li").on('click',function(){
            ...
            var defaultselect = $("#accordion-default"),
                ...
                var func = classbotao + 'Accordion(defaultselect,collapseselect, customizeselect,fillselect,autoopenselect,hoverselect,sortableselect)';
                eval(func);
    ...
    function defaultAccordion(defaultselect,collapseselect, customizeselect,fillselect,autoopenselect,hoverselect,sortableselect) {
        defaultselect.effect('slide');
        collapseselect.hide();
        customizeselect.hide();
        fillselect.hide();
    ...
    function collapseAccordion(defaultselect,collapseselect, customizeselect,fillselect,autoopenselect,hoverselect,sortableselect){
        defaultselect.hide();
        collapseselect.effect('slide');
        customizeselect.hide();
        fillselect.hide();
    ...
    function customizeAccordion(defaultselect,collapseselect, customizeselect,fillselect,autoopenselect,hoverselect,sortableselect){
